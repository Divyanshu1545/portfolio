...
function Hero() {
  return (
    ...
    <div className="wrapper">
      <motion.div initial="initial" animate="animate" className="textContainer" variants={textVariants}>
        <motion.h2 variants={textVariants}>DIVYANSHU DAROLIA</motion.h2>
        <motion.h1 variants={textVariants}>Full Stack Developer and Android Developer</motion.h1>
        <motion.div variants={textVariants} className="buttons">
          <motion.button variants={textVariants} >See the Latest Works</motion.button>
          <motion.button variants={textVariants}>Contact Me</motion.button>
        </motion.div>
        <motion.img variants={textVariants} animate="scrollButton" src={scroll} />
        </motion.div>
      </div>
